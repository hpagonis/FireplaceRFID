...
#ifdef BOARD4
  struct RC522 Rc522[] = {
    {.pin = 17, .uids = {{0x53, 0xB0, 0xFC, 0xCC, 0x60, 0x00, 0x01},{0x53, 0x6C, 0xFA, 0xCC, 0x60, 0x00, 0x01}}, .present = false, .valid = false},
    {.pin =  5, .uids = {{0x53, 0xB1, 0xFC, 0xCC, 0x60, 0x00, 0x01},{0x53, 0x6D, 0xFA, 0xCC, 0x60, 0x00, 0x01}}, .present = false, .valid = false},
